...
*/
const current_usernames = ["Ahmed", "Salman", "Ali", "Moavia", "Shaheer"];
const new_users = ["Muhammad", "Abrar", "Ali", "Imran", "Ahmed"];
function checkUserNames(current_usernames, new_users) {
    const lowercaseCurrentUsers = current_usernames.map(user => user.toLowerCase());
    for (const users of new_users) {
        const lowercaseNewUsers = users.toLowerCase();
